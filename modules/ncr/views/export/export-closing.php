...
$this->title = Yii::t('app', 'Export Closing');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="closing-export">


    <p>
        <?= Html::a('<i class="fa-solid fa-home"></i> ' . Yii::t('app', 'Home'), ['/ncr/ncr-closing/index'], ['class' => 'btn btn-primary']) ?>
    </p>
